...
public class HttpManager {
	...
	public void doPost(String URL, RequestParams requestParams,
			LoadingProgressListener loadingProgressListener,
			LoadingCompleteListener loadingCompletionListener) {
		AsyncHttpResponseHandler handler = new ResponseHandler(
				loadingCompletionListener, loadingProgressListener);
		client.post(URL, requestParams, handler);
	}

	public void doMutipartPost(String url, PostData postData,
			LoadingProgressListener loadingProgressListener,
			LoadingCompleteListener loadingCompletionListener) {
